...
export const Slack = ({ size = 20, className, ...props }: IconProps) => (
  <svg
...
export const Gitlab = ({ size = 20, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="m22 13.29-3.33-10a.42.42 0 0 0-.14-.18.38.38 0 0 0-.22-.08.39.39 0 0 0-.23.07.42.42 0 0 0-.14.18l-2.26 6.67H8.32L6.06 3.24a.42.42 0 0 0-.14-.18.38.38 0 0 0-.22-.08.39.39 0 0 0-.23.07.42.42 0 0 0-.14.18L2 13.29a.74.74 0 0 0 .27.83L12 21l9.69-6.88a.71.71 0 0 0 .31-.83z" />
  </svg>
);

export const Bitbucket = ({ size = 20, className, ...props }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    {...props}
  >
    <path d="M20.67 4.22c-.13-.42-.5-.72-.94-.72H4.27c-.44 0-.81.3-.94.72L1.05 12h21.9L20.67 4.22z" />
    <path d="m2.13 14 1.27 4.19c.14.46.56.81 1.04.81h15.12c.48 0 .9-.35 1.04-.81L21.87 14H2.13z" />
  </svg>
);
